          		...
          		<button onClick={() => signInRedirect(undefined, { callbackUrl: '/'})}>
          			<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-suit-heart" viewBox="0 0 16 16">
						...
						<div className="sm:px-6">
							{/* Date */}
							<div className="mt-2">
								<svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" className="bi bi-calendar-event inline-block mr-2 mb-1" viewBox="0 0 16 16">
							...
							{/* Location */}
							<div className="pt-1">
								<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" className="bi bi-geo-alt inline-block mr-2 mb-1" viewBox="0 0 16 16">
							...
							<div className="bg-white pt-1">
								<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" className="bi bi-flag inline-block mr-2 mb-1" viewBox="0 0 16 16">
							...
							{property.eventAdmission > 0 &&
								<div className="bg-white pt-2">
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cash-coin inline-block mr-2 mb-1" viewBox="0 0 16 16">
							...
							{property.eventDuration > 0 &&
								<div className="bg-white pt-2">
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-clock inline-block mr-2 mb-1" viewBox="0 0 16 16">
