...
export default function EventPage(property: Event) {
	...
	// if user is in list of liked events => setColor to red
	...
	function handleLike() {
		...
		// Send user to list of likes
		// Remove user from database if not liked anymore
	}
	
	return (
		<>
			<div className="grid grid-cols-1 w-full place-items-center">
				<div className="grid m-5 rounded-sm shadow-lg hover:shadow-xl">
						{/* <!-- media container --> */}
						<div className=" flex-none bg-none float-left w-full h-32 overflow-hidden">
							<div className="">
									<img 
						...
						<div className="relative bg-white px-4 pb-4 shadow sm:rounded-lg">
							{/* Heart Button */}
							<div className="relative inset-y-0 right-0 pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
								<div className="absolute top-4 right-0 sm:top-2 sm:right-2">
									<button onClick={handleLike}>
										<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill={color} className="bi bi-suit-heart" viewBox="0 0 16 16">
							...
							<div className="pt-4 sm:px-6">
								...
								{/* Likes */}
								{property.eventLikes.length > 0 &&
									<div className="bg-white pt-2">
										<div className="text-tiny font-bold">{property.eventLikes.length} people like this event!</div>
									</div>
								}
							...
							<div className="sm:px-6">
								...
								{/* Organiser */}
								<div className="bg-white pt-2">
									<div className="text-sm">Organiser: {property.eventOrganiser}</div>
								</div>

								{/* Fee */}
								{property.eventAdmission > 0 &&
									<div className="bg-white pt-2">
										<div className="text-tiny">Admission: £{property.eventAdmission}</div>
									</div>	
								}
								{property.eventAdmission === 0 &&
									<div className="bg-white pt-2">
								...
								{property.eventDuration > 0 &&
									<div className="bg-white pt-2">
										<div className="text-tiny">Duration: {property.eventDuration}h</div>
									</div>	
								}

								{/* Description */}
								<div className="rounded-md bg-slate-100 hover:bg-slate-200 mt-5 shadow-md">
									<div className="text-sm p-3">Description: {property.eventDescription}</div>
								</div>
