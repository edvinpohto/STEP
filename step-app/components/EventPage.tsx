	...
	return (
		<>
			<div className="grid grid-cols-1 w-full place-items-center">
				<div className="grid w-5/6 m-5 rounded-b-lg shadow-lg hover:shadow-xl">
					{/* <!-- media container --> */}
					<div className=" flex-none bg-none rounded-t-lg float-left w-full h-32 overflow-hidden">
						{/* <div className=""> */}
								<img 
